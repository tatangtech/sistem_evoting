          ...
          switch ($hal) {
              //Klik Halaman Home Pengguna
				...
				case 'add-pemilih':
					...
					break;
				case 'import-pemilih':
					include "admin/pemilih/import_pemilih.php";
					break;
				case 'edit-pemilih':
				...
				case 'laporan-pemilih':
					include "admin/pemilih/data_laporan.php";
					break;
    ...
    ?>
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				Copyright &copy;
				<a target="_blank" href="https://www.smkysbsuryalaya.sch.id">
					<strong> SMK Plus YSB Suryalaya</strong>
				</a>
				All rights reserved.
			</div>
		</footer>
